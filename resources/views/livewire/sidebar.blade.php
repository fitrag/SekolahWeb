<div :class="isOpen ? 'w-68' : 'w-[80px]'" class="bg-gray-800 text-white transition-all duration-300 ease-in-out overflow-hidden shadow-lg">
    <div class="border-b border-gray-700 font-semibold text-center py-7">
        <h1 class="font-bold" :class="isOpen ? 'block' : 'hidden'">{{ $schoolName }}</h1> <!-- Menampilkan Nama Sekolah -->
    </div>
